...
A simple C# console application that simulates a smart home controller using text commands. Built for beginners to learn the basics of C# input/output, loops, and conditionals.
